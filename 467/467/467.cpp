...
int main()
{
	...
	while (getline(cin, line)){
		...
		if (currentTime == maxSeconds + 1)cout << "Set " << T << " is unable to synch after one hour.\n";
		else cout << "Set " << T << " synchs again at " << currentTime / 60 << " minute(s) and " << currentTime % 60 << " second(s) after all turning green.\n";
